...
const productDetails = makeStyles({
    smallText: {
        fontSize: 14,
            ...
            <Table>
                <TableBody>
                    <TableRow className={classes.smallText}>
                        ...
                        <TableCell style={{ fontWeight: 600 }}>Delivery charges  ₹40</TableCell>
                    </TableRow>
                    <TableRow className={classes.smallText}>
                    ...
                    <TableRow>
                        <TableCell colSpan={2}>
                            <img src="" style={{ width: 390 }} alt="" />
                        </TableCell>
                    </TableRow>
                    <TableRow className={classes.smallText}>
                        <TableCell className={classes.greyTextColor}>{product.description}</TableCell>
                        <TableCell> </TableCell>
                    </TableRow>
                </TableBody>
            </Table>
